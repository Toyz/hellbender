...
of a course, and how the seven logic routines differ. Weapons, damage and
destruction. What makes an actor start moving - whether all of them move from
the start of the level or some wait for the player.
